...
public class OreGenSettings {
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> METAL_ORE = FeatureUtils.register("metal_ore",
            Feature.ORE, new OreConfiguration(METAL_ORES, 9));
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> EXPOSED_FOSSIL = FeatureUtils.register("exposed_fossil",
            Feature.ORE, new OreConfiguration(EXPOSED_FOSSILS, 5));
